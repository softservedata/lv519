...
//				.build();
	...
	public void checkEcoNews() throws Exception {
		...
		String token = "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ4ZGtueHVzcXZqZW92b3dwZmtAYXdkcnQuY29tIiwiYXV0aG9yaXRpZXMiOlsiUk9MRV9VU0VSIl0sImlhdCI6MTYwMDI0NDMyOSwiZXhwIjoxNjAwMjUxNTI5fQ.5g6RDjMbj_8n010w4dBmPwIpyWq_usSA1CB-SiLDJ44";
		//
		/*-
		...
		*/
		formBody = new MultipartBody.Builder()
				.setType(MultipartBody.FORM)
				.addFormDataPart("image", "@1112.jpg",
